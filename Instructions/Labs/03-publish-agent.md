...
1. In the **Publish** drop-down list, view the published agent details. In particular, note the **Responses API endpoint** that clients apps can use to connect to your agent. You'll need this later!
